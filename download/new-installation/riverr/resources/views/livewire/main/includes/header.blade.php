<header class="bg-white dark:bg-[#0f0f0f] shadow-sm w-full z-40 transition-all duration-200" x-data="window.TTRjRvxLbHzaKxW">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 hidden md:block">
        ...
        {{-- Parent categories --}}
        <ul class="relative flex items-center overflow-y-auto transition-colors duration-300 space-x-5 rtl:space-x-reverse scrollbar-thin scrollbar-thumb-gray-400 dark:scrollbar-thumb-zinc-600 scrollbar-track-gray-50 dark:scrollbar-track-zinc-400">
