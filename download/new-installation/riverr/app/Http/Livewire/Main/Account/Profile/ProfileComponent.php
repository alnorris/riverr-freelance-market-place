...
class ProfileComponent extends Component
{
    ...
    public function updatedAvatar()
    {
        try {
            ...
            $this->dispatchBrowserEvent('alert',[
                "message" => __('messages.t_avatar_updated_successfully'),
            ]);
    ...
    public function setHeadline()
    {
        try {
            ...
            // Success
            $this->dispatchBrowserEvent('alert',[
                "message" => __('messages.t_headline_updated_successfully'),
            ]);
    ...
    public function updateSocial()
    {
        try {
            ...
            // Success
            $this->dispatchBrowserEvent('alert',[
                "message" => __('messages.t_linked_accounts_has_been_updated'),
            ]);
    ...
    public function addSkill()
    {
        try {
            ...
            // Success
            $this->dispatchBrowserEvent('alert',[
                "message" => __('messages.t_skill_added_to_ur_profile'),
            ]);
    ...
    public function deleteSkill($id)
    {
        ...
        // Success
        $this->dispatchBrowserEvent('alert',[
            "message" => __('messages.t_skill_has_been_deleted_from_profile')
        ]);
    }
    ...
    public function updateSkill()
    {
        try {
            ...
            // Success
            $this->dispatchBrowserEvent('alert',[
                "message" => __('messages.t_skill_updated'),
            ]);
    ...
    public function addLanguage()
    {
        try {
            ...
            // Success
            $this->dispatchBrowserEvent('alert',[
                "message" => __('messages.t_language_added_to_ur_profile'),
            ]);
    ...
    public function deleteLanguage($id)
    {
        ...
        // Success
        $this->dispatchBrowserEvent('alert',[
            "message" => __('messages.t_language_has_been_deleted_from_profile')
        ]);
    ...
    public function updateLanguage()
    {
        try {
            ...
            // Success
            $this->dispatchBrowserEvent('alert',[
                "message" => __('messages.t_language_updated'),
            ]);
    ...
    public function updateDescription()
    {
        try {
            ...
            // Success
            $this->dispatchBrowserEvent('alert',[
                "message" => __('messages.t_profile_description_updated'),
            ]);
    ...
    public function setAvailability()
    {
        try {
            ...
            // Success
            $this->dispatchBrowserEvent('alert',[
                "message" => __('messages.t_ur_availability_settings_updated'),
            ]);
            ...
            // Invalid date format
            $this->dispatchBrowserEvent('alert',[
                "message" => __('messages.t_invalid_carbon_date_format'),
                "type"    => "error"
            ]);
