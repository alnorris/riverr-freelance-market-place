...
class DeliverComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.main.seller.orders.options.deliver')->extends('livewire.main.layout.app')->section('content');
    }
        ...
        try {
            ...
            if (!$this->quick_response && !$this->work) {
                ...
                $this->dispatchBrowserEvent('alert',[
                    "message" => __('messages.t_u_have_to_select_deliverd_work_or_quick_response'),
                    "type"    => "error"
                ]);
            ...
            if ($this->order->delivered_work) {
                ...
                // Error
                $this->dispatchBrowserEvent('alert',[
                    "message" => __('messages.t_looks_like_u_already_uploaded_completed_work'),
                    "type"    => "error"
                ]);
